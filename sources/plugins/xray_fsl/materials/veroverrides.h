...
#define MAXVER_INTERNALNAME "wooddent\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "wooddent.dlt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Wood and dent 3D textures (plugin)\0"//should  be overidden on a per-dll level
