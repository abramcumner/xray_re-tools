...
#define MAXVER_INTERNALNAME "procmap\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "procmap.dlt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Procedural texture maps (plugin)\0"//should  be overidden on a per-dll level
