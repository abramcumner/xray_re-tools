...
enum { std2_shader, std2_extended, std2_sampling, std_maps, std2_dynamics, xrFSL_Shaders, };  // pblock IDs
...
// xrFSL_Shaders param IDs
enum
{
	xrFSL_eshader,			// combobox engine shader
	xrFSL_cshader,			// combobox compiler shader
	xrFSL_gshader,			// combobox game shader
};
...
#endif
{
	...
	public:
		...
		static IAutoMParamDlg* m_pxrFSLShadersDlg;
