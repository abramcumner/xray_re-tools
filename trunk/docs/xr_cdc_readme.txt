...
Декомпиляция:	gmcdc.pl [-d input_file] [-o outdir]

-d input_file - входной файл (gamemtl.xr)
-o outdir - папка, куда сохранять конфиги материалов

Компиляция:	gmcdc.pl [-c input_dir] [-o outfile]
...
Декомпиляция:	lcdc.pl [-d input_file] [-o outdir] [-rgb]
...
Компиляция:	lcdc.pl [-c input_dir] [-o outfile] [-rgb]
...
Декомпиляция:	secdc.pl [-d input_file] [-o outdir]

-d input_file - входной файл (lanims.xr)
-o outdir - папка, куда сохранять конфиги анимаций

Компиляция:	secdc.pl [-c input_dir] [-o outfile]
