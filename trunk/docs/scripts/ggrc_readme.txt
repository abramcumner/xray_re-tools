...
4) На выходе получите:
	...
	-в папках уровней файлы level.gct и level.ai.
...
v.0.6 - добавлена коррекция вертексов в кросс-таблицах. Добавлена правка версии xrLC в файле level при
переносе локаций в билды/из билдов.

v.0.5 - пофиксен ряд багов, тестово добавлена поддержка билдов 1911-2201.
