...
Дата последних правок: 18 сентября 2011
...
===[Распаковка спавна]===
Команда:  acdc [-d spawn_file] [-o outdir] [-l] [-g graph_dir]
...
При наличии меток в спавне и при запуске компиляции без ключа -idx, сгенерируется лог, в котором будут
перечислены все 'помеченные' секции.
