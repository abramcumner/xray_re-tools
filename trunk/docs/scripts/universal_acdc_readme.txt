...
Дата последних правок: 17 сентября 2011
...
Добавлена поддержка спавнов модов. Вылет "unknown section" исключен. Для этого необходима папка конфигов мода.
...
===[Распаковка спавна]===
Команда:  acdc [-d spawn_file] [-o outdir] [-l]
...
===[Запаковка спавна]===
Команда:  acdc [-c dir] [-o outfile] [-l]

-c <dir> - папка, в которой лежит запакованный спавн. Если работаете в текущей папке, <dir> не нужно.
