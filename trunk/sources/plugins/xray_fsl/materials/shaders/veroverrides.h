...
#define MAXVER_INTERNALNAME "shaders\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "shaders.dlb\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Standard Shaders (plugin)\0"//should  be overidden on a per-dll level
