...
/*! This contains functions supporting new biped features in Max 9.  in particularly new functionality for setting large number
of keys onto a biped at once, e.g. by loadin an XAF file.
*/
class IBipMaster9: public IBipMaster8 
{
	...
	*/
	...
	//! \param[in] xfmpack  The world transform that we want to set for the biped.
