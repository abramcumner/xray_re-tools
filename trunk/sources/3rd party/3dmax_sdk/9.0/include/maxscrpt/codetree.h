...
#define is_codetree(v) (v->tag == INTERNAL_CODE_TAG)
	void	gc_trace();
...
public:
	...
	DWORD			flags;
			...
			SourceFileWrapper(Value* file_name, Value* code, int pos = -1, DWORD flags = 0);
...
public:
	...
	void	collect() { delete this; }
	ScripterExport void	sprin1(CharStream* s) { s->printf(_M("<line %d>"), pos); }
