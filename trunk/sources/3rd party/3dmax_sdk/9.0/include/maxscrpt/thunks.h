...
#	define	is_toollocalthunk(o)  ((o)->tag == INTERNAL_TOOL_LOCAL_THUNK_TAG)
	void	gc_trace();
	void	collect() { delete this; }
	ScripterExport void	sprin1(CharStream* s);
...
#	define	is_codeblocklocalthunk(o)  ((o)->tag == INTERNAL_CODEBLOCK_LOCAL_TAG)
	void	gc_trace();
	void	collect() { delete this; }
	ScripterExport void	sprin1(CharStream* s);
...
#	define	is_rcmenuitemthunk(p) ((p)->tag == INTERNAL_RCMENU_ITEM_THUNK_TAG)
...
public:
	...
	BOOL	_is_rcmenuthunk() { return 1; }
#	define	is_rcmenulocalthunk(p) ((p)->tag == INTERNAL_RCMENU_LOCAL_THUNK_TAG)
#	define	is_rcmenuthunk(p) ((p)->tag == INTERNAL_RCMENU_LOCAL_THUNK_TAG || (p)->tag == INTERNAL_RCMENU_ITEM_THUNK_TAG)
...
#	define	is_ownerthunk(p) ((p)->tag == INTERNAL_OWNER_THUNK_TAG)
