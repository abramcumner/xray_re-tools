...
enum col_state {booting, pre_gc, in_mutator, in_mark, in_sweep, closing_down, in_coalesce };
...
#define STACK_FRAME_HEADER_SIZE 8 // used internally as the fixed header size when a new stack frame is allocated
