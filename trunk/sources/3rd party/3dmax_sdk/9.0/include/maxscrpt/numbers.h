...
{
public:
#  define  is_integer_number(o) ((o)->tag == class_tag(Integer) || (o)->tag == class_tag(Integer64) || (o)->tag == class_tag(IntegerPtr))
#  define  is_float_number(o) ((o)->tag == class_tag(Float) || (o)->tag == class_tag(Double))
...
#define  is_double(o) ((o)->tag == class_tag(Double))
#define  is_integer(o) ((o)->tag == class_tag(Integer))
#define  is_integer64(o) ((o)->tag == class_tag(Integer64))
#define  is_integerptr(o) ((o)->tag == class_tag(IntegerPtr))
...
#  define  is_int64(o) ((o)->tag == class_tag(Integer64))
	void  collect() { delete this; }
	ScripterExport void  sprin1(CharStream* s);
...
#  define  is_intptr(o) ((o)->tag == class_tag(IntegerPtr))
	void  collect() { delete this; }
	ScripterExport void  sprin1(CharStream* s);
