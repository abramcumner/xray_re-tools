...
REFMSG_TARGET_DELETED messages. The RefTargMonitor class creates a RefTargMonitorRefMaker instance
pointing at a RefTarg, and allows only the REFMSG_TARGET_DELETED message to propogate to the RefTargMonitor's 
