...
//these 2 flags are for internal use right now
#define EDGEVISIBLITY_CHANNEL		(1<<11)  // watje edge visiblity channel used internally to create an edit mesh edge vis cache
#define DONT_RECREATE_TRISTRIP_CHANNEL		(1<<12)  // watje is a channel used to determine whether we should use tri strips or not
