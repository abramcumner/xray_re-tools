...
class BitmapInfo: public MaxHeapOperators {
   ...
   public:
		...
		/*! \defgroup BitmapProxyInfoAccess Proxy Subject Info
...
#define BMM_FLUSH_RELATIVE_FILE_RESOLUTION_CACHE 5 // Used to flush the internal cache used to avoid having to re-resolve relative paths on each LoadInto call
	  ...
	  BMMExport virtual bool CanImport(const TCHAR* filename)=0;
...
class IBitmapProxyManager : public FPStaticInterface {
	public:
		...
		*/
		...
		/*! \defgroup Bitmap Proxy Size Factor values */
		//@{
		enum {
		...
		/*! \defgroup Bitmap Proxy Refresh Request values, used by RefreshProxies() and GenerateProxies()
		*/
		//@{
		enum {
		...
		/*! \defgroup Bitmap Proxy Request flags, used by LoadInto()
		*/
		//@{
		enum {
		...
		/*! \defgroup Bitmap Proxy Load Request values, used by LoadInto()
		*/
		//@{
		enum {
...
/*! \defgroup Bitmap filename resolution functions */
