...
public:
	...
	*/
	...
	//! \brief Retrieves whether to monitor for REFMSG_FLAG_NODES_WITH_SEL_DEPENDENTS messages.
	/*! \returns True if to monitor for REFMSG_FLAG_NODES_WITH_SEL_DEPENDENTS messages.
	*/
	virtual bool GetForwardFlagNodesMsgs() = 0;
	//! \brief Sets whether to monitor for REFMSG_FLAG_NODES_WITH_SEL_DEPENDENTS messages.
	/*! \param state - True if to monitor for REFMSG_FLAG_NODES_WITH_SEL_DEPENDENTS messages.
	*/
