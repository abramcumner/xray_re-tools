...
public:
	...
	*/
	...
	/*!
		...
		\param aDirectory[in] The folder to which the Project Folder should be set.  This value must be
	...
	*/
	...
	/*!
		...
		\param[in] An absolute path to check for the existence of a project.
