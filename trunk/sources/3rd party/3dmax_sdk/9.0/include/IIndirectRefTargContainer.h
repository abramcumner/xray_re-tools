...
This type of container is implemented by Max. Instances of it can be created 
...
Max's implementation of this container type persists itslef and its operations 
support being undone\redone. Furtheremore, the 
