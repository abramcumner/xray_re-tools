...
public:
	...
	*/
	...
	BEGIN_FUNCTION_MAP
		PROP_FNS(kfpGetSrcFileName, GetSrcFileName, kfpSetSrcFileName, FPSetSrcFileName, TYPE_FILENAME);
	...
	protected:
		...
		virtual void FPSetSrcFileName(const TCHAR* fileName) = 0;
		//! \brief Sets item name of xref. Implemented by the system.
		virtual void FPSetSrcItemName(const TCHAR* itemName) = 0;
		//@}
