...
#ifndef __IINDIRECTREFMAKER__H
#define __IINDIRECTREFMAKER__H
#include "maxheap.h"
...
public:
	...
	*/
	virtual BOOL ShouldPersistIndirectRef(RefTargetHandle rtarg) { return FALSE; }
};

// IIndirectReferenceMaker replaces IWeakReferenceMaker.
#pragma deprecated("IWeakReferenceMaker")

#endif // __IINDIRECTREFMAKER__H
