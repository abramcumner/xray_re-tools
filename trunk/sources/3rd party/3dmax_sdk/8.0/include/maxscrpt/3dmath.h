...
#	include "vectpro.h"
	...
	void		to_fpvalue(FPValue& v) { v.p = new Point3 (p); v.type = (ParamType2)TYPE_POINT3_BV; }
...
public:
 ...
 ScripterExport RayValue(Ray init_ray);
	...
	Ray			to_ray() { return r; }
	void		to_fpvalue(FPValue& v) { v.ray = new Ray (r); v.type = TYPE_RAY_BV; }
...
#	include "quatpro.h"
	...
	void		to_fpvalue(FPValue& v) { v.q = new Quat (q); v.type = TYPE_QUAT_BV; }
...
#include "defimpfn.h"
	...
	void		to_fpvalue(FPValue& v) { v.aa = new AngAxis (aa); v.type = TYPE_ANGAXIS_BV; }
...
#include "defimpfn.h"
	...
	void		to_fpvalue(FPValue& v) { Quat q; _EulerToQuat(angles, q); v.q = new Quat (q); v.type = TYPE_QUAT_BV; }
...
#	include "matpro.h"
	...
	void		to_fpvalue(FPValue& v) { v.m = new Matrix3; *v.m = m; v.type = TYPE_MATRIX3_BV; }
...
#include "defimpfn.h"
	...
	void		to_fpvalue(FPValue& v) { v.p2 = new Point2(p); v.type = TYPE_POINT2_BV; }
...
#	include "vectpro.h"
	...
	Point2		to_point2() { return Point2 (p.x, p.y); }
	void		to_fpvalue(FPValue& v) { v.p4 = new Point4 (p); v.type = TYPE_POINT4_BV; }
