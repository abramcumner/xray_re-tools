...
public:
			...
			Value*  info;
			BOOL	debugBreak;
			UserThrownError (TCHAR* d1, Value* ii, BOOL dbgBreak);
			UserThrownError (TCHAR* di, BOOL dbgBreak);
		   ~UserThrownError ();

	void	init(TCHAR* d1, Value* ii, BOOL dbgBreak);
	void	sprin1(CharStream* s);
};
...
public:
	...
	TCHAR*  desc2;
	Value*  info;
	DebuggerRuntimeError (TCHAR* d1);
	DebuggerRuntimeError (TCHAR* d1, TCHAR* d2);
	DebuggerRuntimeError (TCHAR* d1, Value* ii);
	DebuggerRuntimeError (TCHAR* d1, TCHAR* d2, Value* ii);
