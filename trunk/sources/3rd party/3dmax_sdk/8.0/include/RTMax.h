...
public:
	...
	\param %effect The %effect file to parse
	...
	*/
	...
	\param pDevice The main D3D device
	\param %effect The %effect file to parse
	\param texHandle The handle of the texture parameter from the %effect file
	...
	*/
	...
	place to do it
	\param pDevice The main D3D device
	\param pEffect The %effect file to parse
	...
	*/
	...
	//! Get the mapping channels used for this %effect
	/*!
	\return A tab containing the mapping channels
	*/
...
public:
	...
	*/
	...
	//! A simple description of the parser.  This is not currently used in the UI
	/*! 
...
public:
	...
	*/
	...
	/*!
	\param parserID The parser whose description you want
