...
node that drives the data.  for a light this could be position, direction,colr, falloff and hotspot.  The semantic will define the usage.  A binding token will 
