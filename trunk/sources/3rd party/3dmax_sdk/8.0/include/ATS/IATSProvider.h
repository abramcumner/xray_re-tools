...
namespace ATS {
	...
	const DWORD		kATSAPIVersion				= 100;
...
and any attachment files to this file.
\see ATSFileList
*/
class ATSFileEntry {
...
public:
	...
	*/
	ATSExport virtual UINT			AddAttachment( const TCHAR *szFile );
	...
	*/
	...
	\return string that contains attachment file name
	*/
	ATSExport virtual const TCHAR*	GetAttachment( UINT iIndex );
...
protected:
	...
	std::vector< ATSString >		mAttachments;
};
...
public:
	...
	*/
	...
	//! \brief Remove entry
	/*! \param[in] atsFileEntry Pointer to ATSFileEntry object.
	\return true if success, false if failure
	*/
...
public:
	...
	*/
	ATSExport virtual const TCHAR*	GetUserName();
	//! \brief Set user name
	/*! \szFile string containing the user's name
	*/
	ATSExport virtual void			SetUserName( const TCHAR *szUserName );
	...
	*/
	...
	/*! \szFile string containing the user's first name
	*/
	...
	*/
	...
	/*! \szFile string containing the user's last name
	*/
	...
	*/
	...
	/*! \szFile string containing the user's email
	*/
...
public:
	...
	*/
	...
	/*! \param[in] atsFileEntry This ATSUserEntry object is copied and added to the entry list.
	\return pointer to ATSUserEntry object or NULL if failure
	*/
	ATSExport virtual ATSUserEntry*	CreateEntry( ATSUserEntry &atsUserEntry );
	//! \brief Remove entry
	/*! \param[in] atsUserEntry Pointer to ATSUserEntry object.
	\return true if success, false if failure
	*/
...
public:
	...
	*/
	...
	document or document related project files.
