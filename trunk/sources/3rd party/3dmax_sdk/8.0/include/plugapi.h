...
#define MAX_RELEASE             MAX_RELEASE_R8  // The current Max Release number
...
//#define MAX_API_NUM       16	   // R8 pre-release Vesper -- 2005-01-18 -- raffenn
#define MAX_API_NUM       17	   // R8 FCS max 8 -- 2005-09-01 -- raffenn
