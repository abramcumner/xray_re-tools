...
public:
	...
	//
	///
	static MCallbackId	addCallback( Message, MMessage::MBasicFunction func,
	...
	//
	///
	static MCallbackId	addCheckCallback( Message, MMessage::MCheckFunction func,
									 void * clientData = NULL,
									 MStatus * ReturnStatus = NULL );
	...
	//
	///
	static MCallbackId	addCheckFileCallback( Message, MMessage::MCheckFileFunction func,
									 void * clientData = NULL,
									 MStatus * ReturnStatus = NULL );
