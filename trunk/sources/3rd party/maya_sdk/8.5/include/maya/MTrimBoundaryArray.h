...
// An MTrimBoundaryArray object contains a collection of edges on a trim boundary.  
// There can be more than one MObjectArray contained in the MTrimBoundaryArray object.
/**
