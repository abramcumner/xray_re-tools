...
// *****************************************************************************
//
// CLASS DESCRIPTION (MStringResourceId)
//
//  The MStringResourceId class implements a string resource lookup key.
//  It is used in conjunction with the MStringResource class to 
//  retrieve strings from externally defined string resource values. 
...
public:
	...
	MStringResourceId  (const MStringResourceId &);           // ocpy constructor
