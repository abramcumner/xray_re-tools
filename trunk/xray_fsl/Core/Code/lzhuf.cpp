...
using namespace xrFSL;

/********** LZHUF compression **********/

xrFSL_CORE_API void lzh_compress(uint8_t* _code, size_t& _codesize, const uint8_t* _text, size_t _textsize)
{
	xrFSL::xr_lzhuf::compress(_code, _codesize, _text, _textsize);
}

xrFSL_CORE_API void lzh_decompress(uint8_t* _text, size_t& _textsize, const uint8_t* _code, size_t _codesize)
{
	xrFSL::xr_lzhuf::decompress(_text, _textsize, _code, _codesize);
}
