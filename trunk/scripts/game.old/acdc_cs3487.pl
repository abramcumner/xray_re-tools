...
use constant properties_info => (
	...
	{ name => 'version',		type => 'h16',	default => 0x7b },	# 0x30
...
sub state_read {
	...
	$_[1]->unpack_properties($_[0], (properties_info)[12 .. 27]);
	$_[1]->unpack_properties($_[0], (properties_info)[28 .. 38]);
...
Usage: acdc_cs -d all.spawn [-o outdir]
